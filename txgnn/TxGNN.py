...
class TxGNN:
    ...
    def train_graphmask(self, relation = 'indication',
        ...
        self.graphmask_relation = relation
    ...
    def retrieve_save_gates(self, path):
        ...
        scores, _ = self.retrieve_gates_scores_penalties(self.graphmask_relation)
